...
namespace BackPropProgram.Tests
{
    ...
    public class CalculateEnergyThresholding
    {
        ...
        [Test]
        public static void GenerateTruthTableOptimized_Return_Array()
        {
            //act
            DFTModel model = new DFTModel();

            var actual = model.GenerateTruthTableOptimized(4, 2);
            var expected = new List<string> { "0001", "0010", "0100","1000","0011", "0101", "1001", "0110","1010","1100","0111","1011","1101", "1110"
            };
