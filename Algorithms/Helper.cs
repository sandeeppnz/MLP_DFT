...
namespace Algorithms
{
    public static class Helper
    {
        ...
        public static int RefineBasisFunction(string sjVector, string sxVector)
        {
            ...
            else if (i0WildcardCount != 0)
            {
                if (i0WildcardCount == sjVector.Length) //all are 0 * combinations
                {
                    ...
                    return (int) ((Math.Pow(2, i0WildcardCount)) / (Math.Pow(2, i0WildcardCount + i1WildcardCount)));
                    //return (int)((Math.Pow(2, i0WildcardCount)) / (Math.Pow(2, dmArchievalTreeCBDT.stage2WildCardCount)));
            ...
            //MessageBox.Show("In Calculating dot product something has gone wrong.", "Error");
            return 10000;
        }
